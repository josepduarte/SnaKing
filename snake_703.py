...
class MyAgent703(Snake):
    def __init__(self,body=[(0,0)] , direction=(1,0), name="Jewpacabra"):
        ...
        self.aastar_can_find_the_way = False
    ...
    def updateDirection(self,maze):
        ...
        # regular astart
           ...
           # print("BLA3")
            if(self.aastar_can_find_the_way):
                print("==============  ASTAR ============")
                #print("BLA4")
